...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-06-2023 a las 13:05:50
...
--
CREATE DATABASE IF NOT EXISTS `proyecto_final` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci;
USE `proyecto_final`;

CREATE USER 'proyecto_final'@'localhost' IDENTIFIED BY 'proyecto_final';GRANT USAGE ON *.* TO 'proyecto_final'@'localhost';ALTER USER 'proyecto_final'@'localhost' REQUIRE NONE WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0;CREATE DATABASE IF NOT EXISTS `proyecto_final`;GRANT ALL PRIVILEGES ON `proyecto\_final`.* TO 'proyecto_final'@'localhost';
