...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/estilos/general2.css">

	<!-- ESTAMOS ENLAZANDO CSS Y UN FAVICON -->
	<link rel="stylesheet" type="text/css" href="/estilos/verespe.css">
		...
		<article class="navbar">
			<div class="container-fluid">
				<form class="d-flex" action="/buscador/Index" method="post">
					<input class="form-control me-2" type="text" placeholder="Busqueda de Espectáculos" id="buscador" name="buscador">
					<div id="listados">
